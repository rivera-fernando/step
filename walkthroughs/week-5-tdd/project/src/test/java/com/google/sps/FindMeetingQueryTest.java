...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeFullSchedule() {
      //One optional attendee has a meeting all day. It should not affect the scehduling, as
      //he will never be free for the request.
      //
      // Events  :       |--A--|     |--B--|
      //           |--------------C--------------| (OPTIONAL)
      // Day     : |-----------------------------|
  ...
  public void optionalAttendeeOneEvent() {
      //One optional attendee has a single meeting. It should choose the availability where
      //the optional attendee can attend.
      //
      // Events  :       |--A--|--C--|--B--|        (C is optional)
      // Day     : |-----------------------------|
      // Options : |--1--|                 |--3--|
  ...
  @Test
  public void optionalRuinsSlotDuration() {
      //Have one person with just enough room to have the meeting, and one optional attendee
      //whose only meeting would cut into the time for the original attendee.
      //
      // Events  : |--A--|     |----A----|
      //                 |B|                (B is optional)
      // Day     : |---------------------|
  ...
  public void twoOptionalWithGaps() {
    // Have two people, but they are both optional and have various openings
    //
    // Events  :   |-A-|  |A|
    //               |B|       
    // Day     : |---------------------|
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_2_HOUR),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_1100AM, DURATION_1_HOUR),
            Arrays.asList(PERSON_A)),
  ...
  @Test
  public void twoOptionalNoGaps() {
    // Have two people, but they are both optional and neither has any space in schedule
    //
    // Events  : |----------A----------|
    //           |----------B----------|
    // Day     : |---------------------|
